...
Measured in the current source tree on 2026-08-20: 114 Edge Function directories excluding `_shared`, 78 hook files, and 163 SQL migrations. `npm run docs:check` prevents these quoted counts from drifting silently.
