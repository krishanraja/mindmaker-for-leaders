...
Measured at the verified baseline: 113 Edge Function directories excluding `_shared`, 78 hook files, and 158 SQL migrations. `npm run docs:check` prevents these quoted counts from drifting silently.
