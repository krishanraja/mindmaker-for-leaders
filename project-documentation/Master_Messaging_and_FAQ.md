...
- Supabase backend: PostgreSQL with pgvector + pgcrypto + pg_cron, **103 edge functions** (Deno, incl. `generate-skill-export`, the `decision-engine` trio, and the `live-headlines` news pipeline), **78 React hooks**, **147 migrations** applied
