...
- **Commercial:** the kit program (#190-193) is the cohort-facing wedge in practice. Pricing is now SETTLED (2026-07-04): Edge Pro is $49/month, repositioned as the decision tier (unlimited weighs + cross-examination + decision watch + Edge artifacts + the live MCP skills pull); the daily briefing, Automator, Memory, and Voice are free; free gives 3 decision weighs/month. Canonical: `docs/PRICING.md`, `supabase/functions/_shared/edge-pricing.ts`. (Note added 2026-07-26: this section previously said pricing "remains a live commercial decision" - it does not.)
