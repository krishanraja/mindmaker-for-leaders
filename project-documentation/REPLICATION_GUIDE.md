...
> Current scope: 74 edge functions, 53 hooks, 99 migrations, pgvector + pgcrypto + pg_cron. This guide gets you to a runnable instance; full feature parity requires shipping each phase in order (see HISTORY.md), including Phase 8 (Skill Builder + desktop redesign) and Phase 9 (persistence + workflow consolidation).
