      ...
      <div className="container-width relative z-10 py-6 sm:py-8 md:py-12 lg:py-16">
        ...
        <Card className="glass-card">
          <CardContent className="p-12 text-center">
            ...
            {/* AI Attribution */}
            <div className="inline-flex items-center gap-2 bg-blue-500/10 text-blue-600 px-4 py-2 rounded-full text-sm font-caption mb-6">
              <Brain className="h-4 w-4" />
              Results generated by Krish's AI Clone
            </div>
            
            <h3 className="font-display text-3xl text-foreground mb-6">
              Book Your 1-on-1 with Krish
            </h3>
            
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto leading-relaxed">
              Ready to turn these AI insights into real business strategy? Get personalized guidance from Krish himself 
              to implement AI solutions that drive measurable impact for your organization.
            </p>
            
            <div className="glass-card p-8 mb-10 max-w-2xl mx-auto">
              <h4 className="font-heading text-lg text-foreground mb-6">1-on-1 Advisory Session Includes:</h4>
