...
export const WelcomeScreen: React.FC<WelcomeScreenProps> = ({ onStart }) => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background">
      <div className={`diagnostic-container text-center ${isMobile ? 'px-4' : ''}`}>
        <div className="max-w-4xl mx-auto space-y-6 md:space-y-8">
          ...
          <div className="relative py-4 md:py-6">
            ...
            <div className="relative bg-background px-4 md:px-8 py-4">
              <div className={`flex items-center justify-center text-muted-foreground ${
                ...
                {!isMobile && <span className="w-px h-4 bg-border"></span>}
                <span className="flex items-center space-x-2">
          ...
          <div className="pt-4">
            <Button 
              ...
              className={`btn-primary hover:scale-105 transition-transform duration-300 ${
                isMobile 
                  ? 'text-lg px-8 py-4 w-full max-w-sm mx-auto' 
                  : 'text-xl px-12 py-6'
              }`}
            >
              Start your Mindmaking Diagnostic
              <div className={`ml-3 ${isMobile ? 'text-xl' : 'text-2xl'}`}>✨</div>
            </Button>
          </div>
          ...
          <div className="pt-8 md:pt-12 space-y-4">
            ...
            <div className={`flex justify-center text-xs text-muted-foreground/60 ${
              isMobile 
                ? 'flex-col space-y-1' 
                : 'space-x-8'
            }`}>
